...
const StaffRelistAuction = lazy(() => import('./pages/staff/RelistAuction'));
        ...
        <PopUpContextProvider>
            <BrowserRouter>
                <Routes>
                    ...
                    {/* Staff Layout */}
                    <Route path='/staff' element={<Protected authetication={true} userType='admin'><StaffLayout /></Protected>} >
                        {/* Staff Dashboard */}
                        <Route
                        ...
                        {/* Staff Relist Auction */}
                        <Route
                            path='/staff/auctions/relist/:auctionId'
                            element={
                                <Suspense fallback={<LoadingSpinner height={'750px'} />}>
                                    <StaffRelistAuction />
                                </Suspense>

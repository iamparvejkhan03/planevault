...
function AllAuctions() {
    ...
    const fetchAuctions = async (page = 1, search = searchTerm, auctionFilter = filter) => {
        ...
        try {
            ...
            toast.error(err?.response?.data?.message || "Failed to load auctions");
    ...
    const handleEditAuction = (auction) => {
        ...
        // }
        navigate(`/staff/auctions/edit/${auction._id}`);
    };

    const handleRelistAuction = (auction) => {
        navigate(`/staff/auctions/relist/${auction._id}`);
    };

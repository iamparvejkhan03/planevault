...
import { LoadingSpinner, StaffContainer, StaffHeader, StaffSidebar } from "../../components";
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-16">
                                ...
                                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <Link to="/staff/auctions/all" className="bg-green-50 border border-green-200 rounded-lg p-4 text-center hover:bg-green-100 transition-colors group">
                                        ...
                                        <Link to="/staff/transactions" className="bg-purple-50 border border-purple-200 rounded-lg p-4 text-center hover:bg-purple-100 transition-colors group">
                                        ...
                                        <Link to="/staff/commissions" className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center hover:bg-gray-100 transition-colors group">
